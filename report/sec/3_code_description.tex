...
\begin{itemize}
    ...
    \item \textbf{main.py}: Orchestration script that coordinates data loading, model training across multiple seeds, hyperparameter tuning via GridSearchCV, and Kaggle submission generation.
\end{itemize}
...
\begin{figure}[t]
    \vspace{-6pt}
    \centering
    \includegraphics[width=0.48\textwidth]{figures/feature_comparison_table.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{figures/model_hyperparameters.png}
...
\textbf{Cross-Seed Validation:} All experiments are repeated across three random seeds (45, 2025, 777) to quantify result stability and select the best performing model.
